"""
Django settings for silent_feather_dev_67312 project.
...
ROOT_URLCONF = 'silent_feather_dev_67312.urls'
...
WSGI_APPLICATION = 'silent_feather_dev_67312.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_feather_dev_67312 API",
    "DESCRIPTION": "API documentation for silent_feather_dev_67312 App",
    "VERSION": "v1",
}
